...
public interface HasPointsBalance {
    String ADDING_NEGATIVE_POINTS_MESSAGE = "Cannot add negative points to a balance.";
    String REMOVING_NEGATIVE_POINTS_MESSAGE = "Cannot remove negative points from a balance.";
